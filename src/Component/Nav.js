...
return (
    ...
    >
      <div className="container-fluid">
        <a className="navbar-brand fs-3 text-opacity-50 text-primary" href="#" style={style.navHead}>
          PK's Shop
        </a>
        <button
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <Link to="/" className="nav-link active text-light link-d">
                Products
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/addproducts" className="nav-link active text-light link-d">
                Add a product
              </Link>
            </li>
          </ul>
